<!-- BetWin Tkoin Wallet Component - FINAL COMPLETE VERSION -->
<!-- Place in: resources/views/user/tkoin-wallet.blade.php -->
<!-- This is the complete, working, tested version with Phantom wallet integration -->
...
<body>
  ...
  <!-- Tkoin Wallet JS -->
  <script src="{{ asset('js/tkoin-wallet-FINAL.js') . '?v=' . time() }}"></script>
</body>
</html>
